class AdvisorsController < ApplicationController
  ...
  def show
    ...
    # render the time that we passed through instead of the actual start time
    begin
  ...
  private
    ...
    def advisor_params
      params.require(:advisor).permit(:name, :start_time, :end_time, :recurring, :booking_id, :user_id)
    end
end
